function main() {
    ...
    const ouro = new THREE.Mesh(geometrycuboFace1, material);
    const texturaConexaoFrontalInferior = new THREE.Mesh(geometrycuboFace1, material);


    var geometrycuboFace1 = new THREE.PlaneGeometry(0.72, 3.496);
    var material = new THREE.MeshBasicMaterial({ color: 'pink', side: THREE.DoubleSide });
    const ouro2 = new THREE.Mesh(geometrycuboFace1, material);

    var geometrycuboFace1 = new THREE.PlaneGeometry(0.72, 3.496);
    var material = new THREE.MeshBasicMaterial({ color: 'pink', side: THREE.DoubleSide });
    const ouro3 = new THREE.Mesh(geometrycuboFace1, material);

    var geometrycuboFace1 = new THREE.PlaneGeometry(0.82, 0.71);
    var material = new THREE.MeshBasicMaterial({ color: 'pink', side: THREE.DoubleSide });
    const ouro4 = new THREE.Mesh(geometrycuboFace1, material);

    var geometrycuboFace1 = new THREE.PlaneGeometry(0.81, 0.80);
    var material = new THREE.MeshBasicMaterial({ color: 'pink', side: THREE.DoubleSide });
    const ouro5 = new THREE.Mesh(geometrycuboFace1, material);
    ...
    var material = new THREE.MeshBasicMaterial({ color: 'pink', side: THREE.DoubleSide });
    const texturaChassiLateralEsquerda = new THREE.Mesh(geometrycuboFace1, material);
    const texturaChassiLateralDireita = new THREE.Mesh(geometrycuboFace1, material);
    ...
    //Estatua do Lobo
    loadOBJFile('assets/', 'teste', true, 70, -140, 210);
    var statue = null;
    ...
    function ligarSombraCarro() {
        ...
        ouro2.castShadow = true;
        ouro3.castShadow = true;
    ...
    function desligarAutoUpdate() {
        ...
        ouro.matrixAutoUpdate = false;
        texturaConexaoFrontalInferior.matrixAutoUpdate = false;
        ouro4.matrixAutoUpdate = false;
        ...
        ouro2.matrixAutoUpdate = false;
        ouro3.matrixAutoUpdate = false;
    ...
    function resetMatrix() {
        ...
        ouro2.matrix.identity();
        ouro3.matrix.identity();
    }
    ...
    function carInicialPosition() {
        ...
        ouro.matrix.multiply(mat4.makeTranslation(0, 3.25, 0.955));
        texturaConexaoFrontalInferior.matrix.multiply(mat4.makeTranslation(0, 3.25, 0.23));
        ouro2.matrix.multiply(mat4.makeTranslation(-0.41, 3.255, 0.6));
        ouro3.matrix.multiply(mat4.makeTranslation(0.41, 3.255, 0.6));
        ouro4.matrix.multiply(mat4.makeTranslation(0, 5, 0.605));
        ...
        texturaAsaLateralTraseira.matrix.multiply(mat4.makeTranslation(0, -2.31, 1.52));
        texturaAsaBaixo.matrix.multiply(mat4.makeTranslation(0, -2, 1.39));

        ouro5.matrix.multiply(mat4.makeTranslation(0, 1.504, 0.557));
        ...
        texturaChassiLateralEsquerda.matrix.multiply(mat4.makeTranslation(-1.01, 0, 0));
        texturaChassiLateralDireita.matrix.multiply(mat4.makeTranslation(1.01, 0, 0));
    }
    ...
    function setTextura() {
        ...
        var ouroPng = textureLoader.load('assets/pattern2.jpg');
        var ouro2Png = textureLoader.load('assets/fireTexture.jpg');
        var ouro3Png = textureLoader.load('assets/crystal.jpg');
        var texturaPlano = textureLoader.load('assets/pista.jpg');
        var areia = textureLoader.load('assets/sand.jpg');
        ouro.material.map = ouroPng;
        texturaConexaoFrontalInferior.material.map = ouroPng;
        ouro4.material.map = ouroPng;
        texturaAsaCima.material.map = ouro2Png;
        texturaAsaLateral.material.map = ouro2Png;
        texturaAsaLateralTraseira.material.map = ouro2Png;
        texturaAsaBaixo.material.map = ouro2Png;

        ouro5.material.map = ouroPng;
        texturaChassi.material.map = ouro3Png;
        texturaChassiInferior.material.map = ouro3Png;
        texturaChassiFrontal.material.map = ouro3Png;
        texturaChassiTraseira.material.map = ouro3Png;
        texturaChassiLateralEsquerda.material.map = ouro3Png;
        texturaChassiLateralDireita.material.map = ouro3Png;

        ouro2.material.map = ouroPng;
        ouro2.material.map = ouroPng;
        ouro3.material.map = texturaPlano;

        plane.material.map = texturaPlano;
        plane2.material.map = areia;



        // var textureLoader = new THREE.TextureLoader();
        // var ouro = textureLoader.load('../assets/textures/wood.png');
        // var texturaConexaoFrontalInferior = textureLoader.load('../assets/textures/wood.png');
        // var ouro4 = textureLoader.load('../assets/textures/wood.png');
        // var texturaAsaCima = textureLoader.load('../assets/textures/wood.png');
        // var texturaAsaLateral = textureLoader.load('../assets/textures/wood.png');
        // var texturaAsaLateralTraseira = textureLoader.load('../assets/textures/wood.png');
        // var texturaAsaBaixo = textureLoader.load('../assets/textures/wood.png');
        // var ouro5 = textureLoader.load('../assets/textures/wood.png');
        // var texturaChassi = textureLoader.load('../assets/textures/wood.png');
        // var texturaChassiInferior = textureLoader.load('../assets/textures/wood.png');
        // var texturaChassiFrontal = textureLoader.load('../assets/textures/wood.png');
        // var texturaChassiTraseira = textureLoader.load('../assets/textures/wood.png');
        // var texturaChassiLateralEsquerda = textureLoader.load('../assets/textures/wood.png');
        // var texturaChassiLateralDireita = textureLoader.load('../assets/textures/wood.png');
        // var ouro2 = textureLoader.load('../assets/textures/wood.png');
        // var ouro3 = textureLoader.load('../assets/textures/wood.png');
    ...
    function rotate() {
        ...
        ouro2.matrix.multiply(mat4.makeRotationY(degreesToRadians(90)));
        ouro3.matrix.multiply(mat4.makeRotationY(degreesToRadians(90)));
        ouro4.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));
        ouro5.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));


        texturaAsaLateral.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));
        texturaAsaLateralTraseira.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));

        texturaChassiFrontal.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));
        texturaChassiTraseira.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));
        texturaChassiLateralEsquerda.matrix.multiply(mat4.makeRotationY(degreesToRadians(90)));
        texturaChassiLateralDireita.matrix.multiply(mat4.makeRotationY(degreesToRadians(90)));
