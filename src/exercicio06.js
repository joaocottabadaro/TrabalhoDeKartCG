function main()
{
  ...
  var cylinderMaterial4 = new THREE.MeshPhongMaterial( {color:'rgb(255,255,0)'} );
  ...
  function rotateCylinder()
  {
    ...
    if(animationOn)
    {
      ...
      cylinder.matrix.multiply(mat4.makeRotationX(angle)); // R1
      ...
      cylinder3.matrix.multiply(mat4.makeTranslation(0.0, 0.5, 0)); // T1
