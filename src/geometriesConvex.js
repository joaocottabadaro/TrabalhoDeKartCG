function main() {
  ...
  function generatePoints(numberOfPoints) {
    ...
    //   var randomY = Math.round(0); //
    //   var randomZ = Math.round(-maxSize + Math.random() * maxSize * 2);

    //   points.push(new THREE.Vector3(randomX, randomY, randomZ));
    // }

    // for (var i = numberOfPoints/2; i < numberOfPoints; i++) {
    //   var randomX = Math.round(teste);
    //   var randomY = Math.round(maxSize); //
    //   var randomZ = Math.round(teste);
    ...
    points.push(new THREE.Vector3(0, 0, 3));
    points.push(new THREE.Vector3(-3, 0, 4));
    points.push(new THREE.Vector3(4, 0, -3));


    //topo
    points.push(new THREE.Vector3(3,maxSize,0));
    points.push(new THREE.Vector3(3,maxSize,3));
    points.push(new THREE.Vector3(0,maxSize+3,0));
    points.push(new THREE.Vector3(2,maxSize+2,0));
    points.push(new THREE.Vector3(2,maxSize+2,0));
    points.push(new THREE.Vector3(-3,maxSize,3));
    points.push(new THREE.Vector3(0,maxSize,-3));
    points.push(new THREE.Vector3(3,maxSize,0));
    points.push(new THREE.Vector3(-3,maxSize,0));
